...
- ModifierControl matches the dice grid width so the ± buttons expand to fill the remaining space.
- Roll button (#RollBtn) has explicit hover and pressed states via object name to guarantee visual feedback.
